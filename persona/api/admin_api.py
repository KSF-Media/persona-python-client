...
class AdminApi(object):
    ...
    def admin_free_pass_delete(self, body, **kwargs):  # noqa: E501
        ...
        Marks a free pass as being revoked so that it can't be used anymore. Currently, revoked free passes can't be reinstated through Persona API (though it's possible to do so with an SQL query).  # noqa: E501
    ...
    def admin_user_uuid_delete(self, uuid, **kwargs):  # noqa: E501
        """Delete user  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.admin_user_uuid_delete(uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.admin_user_uuid_delete_with_http_info(uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.admin_user_uuid_delete_with_http_info(uuid, **kwargs)  # noqa: E501
            return data

    def admin_user_uuid_delete_with_http_info(self, uuid, **kwargs):  # noqa: E501
        """Delete user  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.admin_user_uuid_delete_with_http_info(uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method admin_user_uuid_delete" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if ('uuid' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `uuid` when calling `admin_user_uuid_delete`")  # noqa: E501
