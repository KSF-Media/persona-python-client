...
class UsersApi(object):
    ...
    def users_admin_post(self, body, **kwargs):  # noqa: E501
        """Create a new user with admin options.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_admin_post(body, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.users_admin_post_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.users_admin_post_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def users_admin_post_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create a new user with admin options.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_admin_post_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method users_admin_post" % key
                )
        ...
        if ('body' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `body` when calling `users_admin_post`")  # noqa: E501
    ...
    def users_search_get(self, query, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.users_search_get_with_http_info(query, **kwargs)  # noqa: E501
        else:
            (data) = self.users_search_get_with_http_info(query, **kwargs)  # noqa: E501
            return data
    ...
    def users_search_get_with_http_info(self, query, **kwargs):  # noqa: E501
        ...
        if ('query' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `query` when calling `users_search_get`")  # noqa: E501
