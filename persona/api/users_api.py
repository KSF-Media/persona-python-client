...
class UsersApi(object):
    ...
    def users_uuid_subscriptions_subsno_reclamation_reclaimno_get(self, uuid, subsno, reclaimno, **kwargs):  # noqa: E501
        """Get a delivery reclamation  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_uuid_subscriptions_subsno_reclamation_reclaimno_get(uuid, subsno, reclaimno, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.users_uuid_subscriptions_subsno_reclamation_reclaimno_get_with_http_info(uuid, subsno, reclaimno, **kwargs)  # noqa: E501
        else:
            (data) = self.users_uuid_subscriptions_subsno_reclamation_reclaimno_get_with_http_info(uuid, subsno, reclaimno, **kwargs)  # noqa: E501
            return data

    def users_uuid_subscriptions_subsno_reclamation_reclaimno_get_with_http_info(self, uuid, subsno, reclaimno, **kwargs):  # noqa: E501
        """Get a delivery reclamation  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_uuid_subscriptions_subsno_reclamation_reclaimno_get_with_http_info(uuid, subsno, reclaimno, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method users_uuid_subscriptions_subsno_reclamation_reclaimno_get" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'uuid' is set
        if ('uuid' not in local_var_params or
                local_var_params['uuid'] is None):
            raise ApiValueError("Missing the required parameter `uuid` when calling `users_uuid_subscriptions_subsno_reclamation_reclaimno_get`")  # noqa: E501
        # verify the required parameter 'subsno' is set
        if ('subsno' not in local_var_params or
                local_var_params['subsno'] is None):
            raise ApiValueError("Missing the required parameter `subsno` when calling `users_uuid_subscriptions_subsno_reclamation_reclaimno_get`")  # noqa: E501
        # verify the required parameter 'reclaimno' is set
        if ('reclaimno' not in local_var_params or
                local_var_params['reclaimno'] is None):
            raise ApiValueError("Missing the required parameter `reclaimno` when calling `users_uuid_subscriptions_subsno_reclamation_reclaimno_get`")  # noqa: E501

        if 'subsno' in local_var_params and local_var_params['subsno'] > 9223372036854775807:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `subsno` when calling `users_uuid_subscriptions_subsno_reclamation_reclaimno_get`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if 'subsno' in local_var_params and local_var_params['subsno'] < -9223372036854775808:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `subsno` when calling `users_uuid_subscriptions_subsno_reclamation_reclaimno_get`, must be a value greater than or equal to `-9223372036854775808`")  # noqa: E501
        if 'reclaimno' in local_var_params and local_var_params['reclaimno'] > 9223372036854775807:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `reclaimno` when calling `users_uuid_subscriptions_subsno_reclamation_reclaimno_get`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if 'reclaimno' in local_var_params and local_var_params['reclaimno'] < -9223372036854775808:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `reclaimno` when calling `users_uuid_subscriptions_subsno_reclamation_reclaimno_get`, must be a value greater than or equal to `-9223372036854775808`")  # noqa: E501
        collection_formats = {}
